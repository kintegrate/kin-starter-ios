...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KinBase/KinBase.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KinGrpcApi/KinGrpcApi.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/kin-stellar-ios-mac-sdk/stellarsdk.framework"
fi
